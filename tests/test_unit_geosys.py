...
class TestGeosys:
    ...
    def test_get_time_series_modis_ndvi(self, get_response):
        get_response.return_value = mock_http_response_text_content("GET", load_binary_data_from_textfile(
            "time_series_modis_ndvi_http_response"))
    ...
    def test_get_satellite_image_time_series_modis_ndvi(self, get_response):
        get_response.return_value = mock_http_response_text_content("GET", load_binary_data_from_textfile(
            "satellite_image_time_series_modis_ndvi_http_response"))
        start_date = dt.datetime.strptime("2020-01-01", "%Y-%m-%d")
        end_date = dt.datetime.strptime("2020-01-07", "%Y-%m-%d")
    ...
    def test_get_satellite_coverage_image_references(self, get_response):
        get_response.return_value = mock_http_response_text_content("GET", load_binary_data_from_textfile(
            "satellite_coverage_image_references_http_response"))
    ...
    def test_get_time_series_weather_historical_daily(self, get_response):
        get_response.return_value = mock_http_response_text_content("GET", load_binary_data_from_textfile(
            "time_series_weather_historical_daily_http_response"))
    ...
    #     df = self.http_client.get_metrics(lai_radar_polygon, schema_id, start_date, end_date)
    ...
    def test_get_time_series_weather_forecast_daily(self, get_response):
        get_response.return_value = mock_http_response_text_content("GET", load_binary_data_from_textfile(
            "time_series_weather_forecast_daily_http_response"))
        start_date = dt.datetime.strptime("2021-01-01", "%Y-%m-%d")
        end_date = dt.datetime.strptime("2022-01-01", "%Y-%m-%d")
        indicators = [
            "Precipitation",
    ...
    def test_get_satellite_image_time_series(self, get_response):
        fake_get_tiff_zip_response =  mock_http_response_binary_content("GET", load_binary_data_from_zipfile("Refletance_map_format.tiff.zip"))
        fake_image_time_series_response =  mock_http_response_text_content("GET", load_binary_data_from_textfile(
           "satellite_image_time_series_landsat8_http_response"))
