...
class Geosys:
    ...
    def __get_satellite_coverage(self, polygon: str,
        ...
        parameters = f"?maps.type=INSEASON_NDVI&Image.Sensor=$in:{'|'.join(sensors)}&CoverageType=CLEAR&$limit=9999&$filter=Image.Date >= '{start_date}' and Image.Date <= '{end_date}'"
    ...
    def __get_weather(self, polygon: str,
        ...
        Args:
            ...
            fields : A list of strings representings the fields to select (eg: Precipitation, Temperature)
